...
/* Конкатинирую созданные из коллекций стримы при помощи статического метода concat.
Сортирую по дате создания через Comparator.comparing.
Обрезаю стрим при помощи метода limit. Собираю всё в список.
 */
